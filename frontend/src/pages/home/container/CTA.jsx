            ...
            <div className="w-3/4 mx-auto relative">
              ...
              <div className="w-full rounded-xl bg-white p-3 z-[1] relative">
                ...
                <div className="p-5">
                  ...
                  Ethical and transparent practices will be paramount in the future of digital marketing, as consumers prioritize trust and authenticity.
                  </p>
                </div>
              </div>
            </div>
